<div class="my-template">
	...
	<h2 class="text-left">Frequently Asked Questions (FAQ)</h2>

	<div class="panel panel-default text-left">
		<div class="panel-body">

<!--			<div class="qanda">-->
<!--				<div>Q: <span class="question">Where is Jonah's cat?</span></div>-->
<!--				<div>A: <span class="answer">No one knows.</span></div>-->
<!--			</div>-->
